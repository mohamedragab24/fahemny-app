...
**الأعراض:** عند محاولة ربط المشروع بمستودع جديد على GitHub، يظهر خطأ يفيد بأن الاتصال (remote) المسمى `origin` موجود بالفعل، على الرغم من أنك قمت بحذف المستودع القديم من GitHub.
...
2. انسخ ونفذ الأمر التالي لإزالة الاتصال القديم:
   ```bash
   git remote rm origin
   ```
3. بعد ذلك، حاول ربط المشروع مرة أخرى. ستتمكن الآن من استخدام `origin` كاسم للاتصال بنجاح.
