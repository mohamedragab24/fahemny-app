...
export default async function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      title: t.features.choose.title,
      description: t.features.choose.description,
    },
    {
      icon: <Wallet className="w-8 h-8 text-primary" />,
      title: t.features.pay.title,
      description: t.features.pay.description,
    },
  ];
      ...
      <section id="features" className="w-full py-12 md:py-24 lg:py-32 bg-secondary/50">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <div className="inline-block rounded-lg bg-secondary px-3 py-1 text-sm">{t.features.heading}</div>
